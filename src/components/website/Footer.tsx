...
const Footer = (props: Props) => {
  return (
    <div className="bg-white py-14 border-t border-gray-400 px-10">
      <div className=" container mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
